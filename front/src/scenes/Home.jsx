    ...
    >
      ...
      {!loading && !props.isLogged && (
        <>
          ...
          <p style={{ maxWidth: '1064px', margin: '15px auto', padding: '15px' }}>Lorem ipsum fugiat labore minim et aute in est ea et laborum officia id tempor pariatur nisi nisi aliquip dolore veniam enim incididunt cillum qui in veniam laboris labore sed nostrud laboris sint pariatur sint culpa commodo.</p>
        </>
      )}
